...
const TeamPage = () => {
  ...
  const teamName = team.nombre || nombre || 'Equipo';
  const description = team.club
    ? `Equipo ${teamName} del club ${team.club} de Bohurt Argentina.`
    : `Equipo ${teamName} de Bohurt Argentina.`;
  ...
  return (
    <>
      <SeoHead
        ...
        pathname={`/team/${encodeURIComponent(teamName)}`}
      />
      <div className="card">
        {loading ? (
